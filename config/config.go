...
import (
	...
	"github.com/qiaopengjun5162/VRFService/flags"
)
...
type ChainConfig struct {
	...
	PrivateKey                          string
	VerifyRandVRFContractAddress        string
	VerifyRandVRFFactoryContractAddress string
...
func LoadContracts() []common.Address {
	...
	Contracts = append(Contracts, VerifyRandVRFAddr)
	return Contracts
}
...
func NewConfig(ctx *cli.Context) Config {
	return Config{
		...
		Chain: ChainConfig{
			...
			VerifyRandVRFContractAddress:        ctx.String(flags.VerifyRandVRFContractAddressFlag.Name),
			VerifyRandVRFFactoryContractAddress: ctx.String(flags.VerifyRandVRFFactoryContractAddressFlag.Name),
