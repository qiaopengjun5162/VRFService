...
const envVarPrefix = "VERIFY_RAND_VRF"
...
var (
	...
	VerifyRandVRFContractAddressFlag = &cli.StringFlag{
		Name:     "verify-rand-vrf-address",
		Usage:    "Address of the treasure manager contract",
		EnvVars:  prefixEnvVars("VERIFY_RAND_VRF_ADDRESS"),
		Required: true,
	}
	VerifyRandVRFFactoryContractAddressFlag = &cli.StringFlag{
		Name:     "verify-rand-vrf-factory-address",
		Usage:    "Address of the verify rand vrf factory",
		EnvVars:  prefixEnvVars("VERIFY_RAND_VRF_FACTORY_ADDRESS"),
		Required: true,
	}
	CallerAddressFlag = &cli.StringFlag{
		Name:     "caller_address",
		Usage:    "contract caller for verify rand vrf",
...
var requiredFlags = []cli.Flag{
	...
	CallIntervalFlag,
	PrivateKeyFlag,
	VerifyRandVRFContractAddressFlag,
	VerifyRandVRFFactoryContractAddressFlag,
	CallerAddressFlag,
