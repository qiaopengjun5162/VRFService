...
import (
	...
	common2 "github.com/qiaopengjun5162/VRFService/database/common"
	"github.com/qiaopengjun5162/VRFService/database/event"
	"github.com/qiaopengjun5162/VRFService/database/utils"
...
func NewSynchronizer(cfg *config.Config, db *database.DB, client node.EthClient, shutdown context.CancelCauseFunc) (*Synchronizer, error) {
	...
	return &Synchronizer{
		loopInterval:     cfg.Chain.MainLoopInterval * time.Second,
		headerBufferSize: cfg.Chain.BlockStep,
